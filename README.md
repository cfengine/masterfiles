...
|  3.18.x | [![Core Build Status](https://travis-ci.org/cfengine/core.svg?branch=3.18.x)](https://travis-ci.org/cfengine/core) | [![MPF Build Status](https://travis-ci.org/cfengine/masterfiles.svg?branch=3.18.x)](https://travis-ci.org/cfengine/masterfiles) |
